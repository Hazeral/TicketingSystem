...
| /api/users/ip/:ip                  | GET    | Get array of all users using specified IP                    | admin<br>moderator            | -                                                       |
| /api/users/ip/:ip/block            | POST   | Block all users on an IP and block further accounts from being created | admin<br>moderator            | reason: required<br/>expires: optional (timestamp)      |
| /api/users/ip/:ip/unblock          | POST   | Unblock IP including all affected accounts                   | admin                         | reason: required                                        |
...
| /api/user/:id/blockip              | POST   | Block user IP, all accounts on latest IP will be blocked, any new accounts made from the IP will also be blocked | admin<br>moderator            | reason: required<br/>expires: optional (timestamp)      |
...
| /api/user/:id/ips                  | GET    | Get list of IPs used with counter of how many times used     | admin<br>moderator            | -                                                       |
| /api/user/:id/sameip               | GET    | Get list of all accounts using same IPs as user, will also list which IPs for each account | admin<br>moderator            | -                                                       |
